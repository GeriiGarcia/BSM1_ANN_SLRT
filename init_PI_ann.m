...
% Weights Direct LSTM
w1 = csvread('./DAE_ANN/ANN/Weights/30_04_21/lstm_ann_pi_standard_fix_noSo4_rnn_1__100_16_W_3.csv');
u1 = csvread('./DAE_ANN/ANN/Weights/30_04_21/lstm_ann_pi_standard_fix_noSo4_rnn_1__100_16_U_3.csv');
b1 = csvread('./DAE_ANN/ANN/Biases/30_04_21/lstm_ann_pi_standard_fix_noSo4_rnn_1__100_16_b_3.csv');
w2 = csvread('./DAE_ANN/ANN/Weights/30_04_21/lstm_ann_pi_standard_fix_noSo4_rnn_1__100_16_W_3.csv');
u2 = csvread('./DAE_ANN/ANN/Weights/30_04_21/lstm_ann_pi_standard_fix_noSo4_rnn_1__100_16_U_3.csv');
b2 = csvread('./DAE_ANN/ANN/Biases/30_04_21/lstm_ann_pi_standard_fix_noSo4_rnn_1__100_16_b_3.csv');
w_out = csvread('./DAE_ANN/ANN/Weights/30_04_21/lstm_ann_pi_standard_fix_noSo4_final__100_16_W_3.csv');
b_out = csvread('./DAE_ANN/ANN/Biases/30_04_21/lstm_ann_pi_standard_fix_noSo4_final__100_16_b_3.csv');
...
mean_scaler_dir = csvread('./DAE_ANN/ANN/Scalers/30_04_21_lstm_ann_pi_standard_fix_noSo4/mean_scaler_lstm_ann_pi_standard_fix_noSo4.csv');
std_scaler_dir = csvread('./DAE_ANN/ANN/Scalers/30_04_21_lstm_ann_pi_standard_fix_noSo4/std_scaler_lstm_ann_pi_standard_fix_noSo4.csv');
mean_scaler_dir_out = csvread('./DAE_ANN/ANN/Scalers/30_04_21_lstm_ann_pi_standard_fix_noSo4/mean_scaler_lstm_ann_pi_standard_fix_noSo4_out.csv');
std_scaler_dir_out = csvread('./DAE_ANN/ANN/Scalers/30_04_21_lstm_ann_pi_standard_fix_noSo4/std_scaler_lstm_ann_pi_standard_fix_noSo4_out.csv');
% 
